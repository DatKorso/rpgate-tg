...
Просто опиши что ты хочешь сделать, остальное сделает GM!"""
    ...
    # Full reset flow (complete purge of previous character history)
    FULL_RESET_WARNING = (
        "🧨 **Полный сброс**\n\n"
        "Это удалит твоего текущего героя и всю историю: сессии, воспоминания и состояние мира. "
        "Действие нельзя отменить. Продолжить?"
    )
    FULL_RESET_CANCELLED = "✅ Сброс отменён. Твой герой и история сохранены."
    FULL_RESET_DONE = (
        "🧨 Прошлый герой и его история полностью удалены. Создай нового персонажа, выбери класс:\n\n"
        "⚠️ Начинается абсолютно новая история без какого-либо прошлого."
    )
    FULL_RESET_ERROR = (
        "❌ Не удалось выполнить полный сброс. Попробуй позже или обратись к /help.\n"
        "История не удалена."
    )


class SettingsPrompts:
    """Prompts for /settings command and combat toggle."""
    SETTINGS_HEADER = """⚙️ **Настройки**

Ты можешь настроить стиль игры. Если отключить боевую систему — все действия будут интерпретироваться чисто нарративно без бросков кубиков.

Текущее состояние боевой системы: **{combat_status}**

Команды:
• /combat_off — отключить боевую систему (нарративный режим)
• /combat_on — включить боевую систему (игровая механика + броски)
"""

    COMBAT_DISABLED_CONFIRM = "🔕 Боевая система отключена. Все действия теперь описываются без бросков кубиков. Нарративный режим активирован."
    COMBAT_ENABLED_CONFIRM = "⚔️ Боевая система включена. Броски и механика снова активны."
    COMBAT_ALREADY_DISABLED = "ℹ️ Боевая система уже отключена. Используй /combat_on чтобы вернуть механику."
    COMBAT_ALREADY_ENABLED = "ℹ️ Боевая система уже включена. Используй /combat_off чтобы перейти в нарративный режим."
    ERROR_SETTINGS = "❌ Ошибка загрузки настроек. Попробуй позже."
