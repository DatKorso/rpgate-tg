...
|----------|-------------|--------------|
| **[STRATEGIC_PLAN.md](STRATEGIC_PLAN.md)** | Архитектура & Roadmap | 30 мин |
| **[SPRINT3_PROGRESS.md](SPRINT3_PROGRESS.md)** | Текущее состояние системы | 15 мин |
| **[API_CONTRACTS.md](API_CONTRACTS.md)** | Форматы данных агентов | 10 мин |

### Для разработки

| Документ | Когда читать | Для кого |
|----------|-------------|----------|
| **[SPRINT2_SPEC.md](SPRINT2_SPEC.md)** | Исторический спринт (для справки) | Dev / PM |
| **[API_CONTRACTS.md](API_CONTRACTS.md)** | При интеграции/валидации агентов | Dev |
| **[development-plan.md](development-plan.md)** | История Sprint 1 | Dev |

### Для отслеживания прогресса

| Документ | Когда обновлять | Для кого |
|----------|----------------|----------|
| **[SPRINT1_CHECKLIST.md](SPRINT1_CHECKLIST.md)** | Sprint 1 status | ✅ Complete |
| **[SPRINT3_PROGRESS.md](SPRINT3_PROGRESS.md)** | Consolidated Sprint 3 summary | ✅ Complete |
| **[CHANGELOG.md](CHANGELOG.md)** | Технические фиксы и миграции | 🔄 Ongoing |
...
### 📝 development-plan.md (renamed from developent-plan.md)
...
- Обучающий материал для понимания структуры specs (исторический документ)
